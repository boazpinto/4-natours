...
var savePasswordForm = document.querySelector('.form-user-password');
var updatePasswordBtn = document.querySelector('.updatePassword');
...
if (savePasswordForm) {
  savePasswordForm.addEventListener('submit', /*#__PURE__*/function () {
